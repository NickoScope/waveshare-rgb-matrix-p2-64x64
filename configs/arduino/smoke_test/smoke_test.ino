...
//
// ВНИМАНИЕ. Скетч в сессии сборки базы знаний не компилировался.
// Распиновка взята из конфига hub75-studio, а не из официальной схемы Waveshare.
// Сверить с hardware/schematics репозитория waveshareteam/ESP32-S3-RGB-Matrix.
//
...
void setup() {
  ...
  // Waveshare для этой панели указывает драйвер Generic, то есть
  // инициализация FM6126A не нужна. Строку ниже включать только если экран чёрный.
