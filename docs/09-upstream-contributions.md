...
**Sent:** the settings fix as PR #5, 2026-09-17 16:53 (https://github.com/Keralots/AnimatedPixelClock/pull/5), **merged by Rafał the same day at 15:30 UTC**; the weather task as PR #6, 2026-09-17 18:17 (https://github.com/Keralots/AnimatedPixelClock/pull/6), **merged at 16:38 UTC the same day** as `9fa9ba4`, no review comments. the crash report as PR #7, 2026-09-17 19:52 (https://github.com/Keralots/AnimatedPixelClock/pull/7), **merged at 18:27 UTC** as `eb43f15`. **Four offered, four merged, not one review comment.** The fifth is in too: PR #8, 2026-09-17 20:53 (https://github.com/Keralots/AnimatedPixelClock/pull/8), **merged 19:03 UTC** as `517b37d` - the cause name kept across a firmware update, found on the panel and tested there. **Five offered, five merged, no review comments; none of them has shipped in a release yet (still v2.3.1).** The gzip portal, the last item he asked for, is out as PR #9 (2026-09-18 09:43, https://github.com/Keralots/AnimatedPixelClock/pull/9), measured on the panel before it was sent. **His queue from issue #3 is then empty.**
