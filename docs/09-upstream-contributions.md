...
**Sent:** the settings fix as PR #5, 2026-09-17 16:53 (https://github.com/Keralots/AnimatedPixelClock/pull/5), **merged by Rafał the same day at 15:30 UTC**; the weather task as PR #6, 2026-09-17 18:17 (https://github.com/Keralots/AnimatedPixelClock/pull/6). Left: the boot_health crash report, then the gzip portal.
