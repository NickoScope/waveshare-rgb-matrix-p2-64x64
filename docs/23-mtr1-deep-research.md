...
**Both are in the model since 2026-09-16** (`kConfirm = 2`, `kTeleportMm = 1500`). The thresholds come from the measurements above: a person's step is 40 mm median and 537 mm at p95, the ghost jumped over a metre 25 times and as far as 3 m. The price is recorded in the host tests: a target returning after an absence appears one message later, about a second.
